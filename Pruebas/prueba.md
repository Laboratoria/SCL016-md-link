...
(empezando por el tradicional.(https://developers.google123.com/v8/)
...
(https://nodejs.org/es/) es un entorno de ejecución para JavaScript
...
propia librería (o biblioteca - library) en JavaScript.(https://nodejs.org/es/link-roto)
